...
const Navbar = () => {
  return (
    <div className="navbar max-w-screen-2xl container mx-auto bg-white px-5 ">
        ...
        <div className="navbar-center hidden lg:flex text-[#21272A]">
    ...
    <Link to={"/pricing"} className="btn bg-primary btn-primary text-white "> Start Free Trial</Link>
  </div>
    </div>
);
};
